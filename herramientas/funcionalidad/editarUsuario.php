...
$sqlUsu     = 'UPDATE usuario SET nombre_usu="%s", apellidopa_usu="%s", apellidoma_usu="%s", tel_usu="%s" WHERE idusu = %d;';
$sqlCUsu    = 'UPDATE cuentausuario  SET nom_user="%s", contrasena=md5("%s") WHERE idusu = %d;';
$con        = new Conexion($Host,$User,$Pass,$dbName);
$sql        = sprintf($sqlUsu,$nombre,$apellidopa,$apellidoma,$telefono,$_SESSION['IDUSU']);
